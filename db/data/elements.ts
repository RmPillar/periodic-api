export default [
  ...
  },
  {
    ...
    electron_configuration: "[Ne] 3s^2 3p^2",
    atomic_radius: 2.1,
  ...
  },
  {
    ...
    discovery_date: 1669,
    discovered_by: "Hennig Brandt",
    name_origin:
      "The name is derived from the Greek 'phosphoros', meaning bringer of light.",
    electron_configuration: "[Ne] 3s^2 3p^3",
    atomic_radius: 1.8,
    covalent_radius: 1.09,
  ...
  },
  {
    ...
    electron_configuration: "[Ne] 3s^2 3p^4",
    atomic_radius: 1.8,
    covalent_radius: 1.04,
